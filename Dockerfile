...
&& wget https://static-ddys.oss-cn-shenzhen.aliyun.com/linux/elasticsearch-1.7.0.deb \
...
&& curl -sL "https://static-ddys.oss-cn-shenzhen.aliyun.com/linux/setup_nodejs_10.x" | sh \
...
#golang-env
RUN apt-get update \
&& wget https://static-ddys.oss-cn-shenzhen.aliyun.com/linux/go1.11.linux-amd64.tar.gz -O go.tar.gz \
